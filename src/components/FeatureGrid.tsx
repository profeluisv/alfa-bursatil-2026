...
const features = [
  {
    ...
    description: 'Métricas de volumen y momentum'
  },
  {
    icon: TrendingUp,
    command: '/rentabilidad',
    title: 'Sharpe Ratio',
    description: 'Evaluación de retorno ajustado por riesgo en tiempo real'
  },
  {
    icon: Zap,
    command: '/liquidez',
    title: 'Métricas de Volumen',
    description: 'Análisis de liquidez y detección de oportunidades'
  },
  {
    icon: Target,
    command: '/ath',
    title: 'Arbitraje de Precios',
    description: 'Identificación de activos cerca de máximos históricos'
  }
];
